...
export class ELBv2 {
  ...
  async addListenerCertificates(
    params: s.AddListenerCertificatesInput,
  ...
  async createTargetGroup(
    params: s.CreateTargetGroupInput,
  ...
  async deleteLoadBalancer(
    params: s.DeleteLoadBalancerInput,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"LoadBalancerArn", (params["LoadBalancerArn"] ?? '').toString());
  ...
  async deleteTargetGroup(
    params: s.DeleteTargetGroupInput,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async deregisterTargets(
    params: s.DeregisterTargetsInput,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"TargetGroupArn", (params["TargetGroupArn"] ?? '').toString());
  ...
  async describeListenerCertificates(
    params: s.DescribeListenerCertificatesInput,
  ...
  async describeListeners(
    params: s.DescribeListenersInput = {},
  ...
  async describeLoadBalancers(
    params: s.DescribeLoadBalancersInput = {},
  ...
  async describeSSLPolicies(
    params: s.DescribeSSLPoliciesInput = {},
  ...
  async describeTargetGroupAttributes(
    params: s.DescribeTargetGroupAttributesInput,
  ...
  async describeTargetGroups(
    params: s.DescribeTargetGroupsInput = {},
  ...
  async describeTargetHealth(
    params: s.DescribeTargetHealthInput,
  ...
  async modifyTargetGroup(
    params: s.ModifyTargetGroupInput,
  ...
  async modifyTargetGroupAttributes(
    params: s.ModifyTargetGroupAttributesInput,
  ...
  async removeListenerCertificates(
    params: s.RemoveListenerCertificatesInput,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"ListenerArn", (params["ListenerArn"] ?? '').toString());
  ...
  async setIpAddressType(
    params: s.SetIpAddressTypeInput,
  ...
  async setRulePriorities(
    params: s.SetRulePrioritiesInput,
  ...
  async setSecurityGroups(
    params: s.SetSecurityGroupsInput,
