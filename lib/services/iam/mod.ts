...
export class IAM {
  ...
  async addRoleToInstanceProfile(
    params: s.AddRoleToInstanceProfileRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async attachGroupPolicy(
    params: s.AttachGroupPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"GroupName", (params["GroupName"] ?? '').toString());
  ...
  async attachRolePolicy(
    params: s.AttachRolePolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"RoleName", (params["RoleName"] ?? '').toString());
  ...
  async attachUserPolicy(
    params: s.AttachUserPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async changePassword(
    params: s.ChangePasswordRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async createAccessKey(
    params: s.CreateAccessKeyRequest = {},
  ...
  async createAccountAlias(
    params: s.CreateAccountAliasRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async createLoginProfile(
    params: s.CreateLoginProfileRequest,
  ...
  async createOpenIDConnectProvider(
    params: s.CreateOpenIDConnectProviderRequest,
  ...
  async createPolicyVersion(
    params: s.CreatePolicyVersionRequest,
  ...
  async createSAMLProvider(
    params: s.CreateSAMLProviderRequest,
  ...
  async createServiceLinkedRole(
    params: s.CreateServiceLinkedRoleRequest,
  ...
  async createVirtualMFADevice(
    params: s.CreateVirtualMFADeviceRequest,
  ...
  async deactivateMFADevice(
    params: s.DeactivateMFADeviceRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteAccessKey(
    params: s.DeleteAccessKeyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    if ("UserName" in params) body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteGroupPolicy(
    params: s.DeleteGroupPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"GroupName", (params["GroupName"] ?? '').toString());
  ...
  async deleteLoginProfile(
    params: s.DeleteLoginProfileRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteOpenIDConnectProvider(
    params: s.DeleteOpenIDConnectProviderRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"OpenIDConnectProviderArn", (params["OpenIDConnectProviderArn"] ?? '').toString());
  ...
  async deletePolicyVersion(
    params: s.DeletePolicyVersionRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"PolicyArn", (params["PolicyArn"] ?? '').toString());
  ...
  async deleteRolePermissionsBoundary(
    params: s.DeleteRolePermissionsBoundaryRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"RoleName", (params["RoleName"] ?? '').toString());
  ...
  async deleteSAMLProvider(
    params: s.DeleteSAMLProviderRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async deleteSSHPublicKey(
    params: s.DeleteSSHPublicKeyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteServerCertificate(
    params: s.DeleteServerCertificateRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async deleteServiceLinkedRole(
    params: s.DeleteServiceLinkedRoleRequest,
  ...
  async deleteServiceSpecificCredential(
    params: s.DeleteServiceSpecificCredentialRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    if ("UserName" in params) body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteUserPolicy(
    params: s.DeleteUserPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async deleteVirtualMFADevice(
    params: s.DeleteVirtualMFADeviceRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"SerialNumber", (params["SerialNumber"] ?? '').toString());
  ...
  async detachGroupPolicy(
    params: s.DetachGroupPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"GroupName", (params["GroupName"] ?? '').toString());
  ...
  async detachRolePolicy(
    params: s.DetachRolePolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"RoleName", (params["RoleName"] ?? '').toString());
  ...
  async enableMFADevice(
    params: s.EnableMFADeviceRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async generateCredentialReport(): Promise<s.GenerateCredentialReportResponse> {
    const resp = await this.#client.performRequest({
  ...
  async generateOrganizationsAccessReport(
    params: s.GenerateOrganizationsAccessReportRequest,
  ...
  async generateServiceLastAccessedDetails(
    params: s.GenerateServiceLastAccessedDetailsRequest,
  ...
  async getAccessKeyLastUsed(
    params: s.GetAccessKeyLastUsedRequest,
  ...
  async getAccountAuthorizationDetails(
    params: s.GetAccountAuthorizationDetailsRequest = {},
  ...
  async getAccountPasswordPolicy(): Promise<s.GetAccountPasswordPolicyResponse> {
    const resp = await this.#client.performRequest({
  ...
  async getAccountSummary(): Promise<s.GetAccountSummaryResponse> {
    const resp = await this.#client.performRequest({
  ...
  async getContextKeysForCustomPolicy(
    params: s.GetContextKeysForCustomPolicyRequest,
  ...
  async getCredentialReport(): Promise<s.GetCredentialReportResponse> {
    const resp = await this.#client.performRequest({
  ...
  async getGroupPolicy(
    params: s.GetGroupPolicyRequest,
  ...
  async getInstanceProfile(
    params: s.GetInstanceProfileRequest,
  ...
  async getLoginProfile(
    params: s.GetLoginProfileRequest,
  ...
  async getOpenIDConnectProvider(
    params: s.GetOpenIDConnectProviderRequest,
  ...
  async getOrganizationsAccessReport(
    params: s.GetOrganizationsAccessReportRequest,
  ...
  async getPolicyVersion(
    params: s.GetPolicyVersionRequest,
  ...
  async getSAMLProvider(
    params: s.GetSAMLProviderRequest,
  ...
  async getSSHPublicKey(
    params: s.GetSSHPublicKeyRequest,
  ...
  async getServerCertificate(
    params: s.GetServerCertificateRequest,
  ...
  async getServiceLastAccessedDetailsWithEntities(
    params: s.GetServiceLastAccessedDetailsWithEntitiesRequest,
  ...
  async getServiceLinkedRoleDeletionStatus(
    params: s.GetServiceLinkedRoleDeletionStatusRequest,
  ...
  async listAccessKeys(
    params: s.ListAccessKeysRequest = {},
  ...
  async listAttachedGroupPolicies(
    params: s.ListAttachedGroupPoliciesRequest,
  ...
  async listAttachedRolePolicies(
    params: s.ListAttachedRolePoliciesRequest,
  ...
  async listAttachedUserPolicies(
    params: s.ListAttachedUserPoliciesRequest,
  ...
  async listEntitiesForPolicy(
    params: s.ListEntitiesForPolicyRequest,
  ...
  async listGroupsForUser(
    params: s.ListGroupsForUserRequest,
  ...
  async listInstanceProfiles(
    params: s.ListInstanceProfilesRequest = {},
  ...
  async listInstanceProfilesForRole(
    params: s.ListInstanceProfilesForRoleRequest,
  ...
  async listMFADeviceTags(
    params: s.ListMFADeviceTagsRequest,
  ...
  async listMFADevices(
    params: s.ListMFADevicesRequest = {},
  ...
  async listOpenIDConnectProviderTags(
    params: s.ListOpenIDConnectProviderTagsRequest,
  ...
  async listOpenIDConnectProviders(): Promise<s.ListOpenIDConnectProvidersResponse> {
    const body = new URLSearchParams;
    const resp = await this.#client.performRequest({
      body,
  ...
  async listPoliciesGrantingServiceAccess(
    params: s.ListPoliciesGrantingServiceAccessRequest,
  ...
  async listPolicyVersions(
    params: s.ListPolicyVersionsRequest,
  ...
  async listSAMLProviderTags(
    params: s.ListSAMLProviderTagsRequest,
  ...
  async listSAMLProviders(): Promise<s.ListSAMLProvidersResponse> {
    const body = new URLSearchParams;
    const resp = await this.#client.performRequest({
      body,
  ...
  async listSSHPublicKeys(
    params: s.ListSSHPublicKeysRequest = {},
  ...
  async listServerCertificateTags(
    params: s.ListServerCertificateTagsRequest,
  ...
  async listServiceSpecificCredentials(
    params: s.ListServiceSpecificCredentialsRequest = {},
  ...
  async listSigningCertificates(
    params: s.ListSigningCertificatesRequest = {},
  ...
  async listUserPolicies(
    params: s.ListUserPoliciesRequest,
  ...
  async listVirtualMFADevices(
    params: s.ListVirtualMFADevicesRequest = {},
  ...
  async putGroupPolicy(
    params: s.PutGroupPolicyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"GroupName", (params["GroupName"] ?? '').toString());
  ...
  async putRolePermissionsBoundary(
    params: s.PutRolePermissionsBoundaryRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"RoleName", (params["RoleName"] ?? '').toString());
  ...
  async putUserPermissionsBoundary(
    params: s.PutUserPermissionsBoundaryRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async removeRoleFromInstanceProfile(
    params: s.RemoveRoleFromInstanceProfileRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"InstanceProfileName", (params["InstanceProfileName"] ?? '').toString());
  ...
  async removeUserFromGroup(
    params: s.RemoveUserFromGroupRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"GroupName", (params["GroupName"] ?? '').toString());
  ...
  async resetServiceSpecificCredential(
    params: s.ResetServiceSpecificCredentialRequest,
  ...
  async resyncMFADevice(
    params: s.ResyncMFADeviceRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async setDefaultPolicyVersion(
    params: s.SetDefaultPolicyVersionRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"PolicyArn", (params["PolicyArn"] ?? '').toString());
  ...
  async setSecurityTokenServicePreferences(
    params: s.SetSecurityTokenServicePreferencesRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async simulateCustomPolicy(
    params: s.SimulateCustomPolicyRequest,
  ...
  async simulatePrincipalPolicy(
    params: s.SimulatePrincipalPolicyRequest,
  ): Promise<s.SimulatePolicyResponse> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"PolicySourceArn", (params["PolicySourceArn"] ?? '').toString());
  ...
  async tagOpenIDConnectProvider(
    params: s.TagOpenIDConnectProviderRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"OpenIDConnectProviderArn", (params["OpenIDConnectProviderArn"] ?? '').toString());
  ...
  async tagSAMLProvider(
    params: s.TagSAMLProviderRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"SAMLProviderArn", (params["SAMLProviderArn"] ?? '').toString());
  ...
  async untagInstanceProfile(
    params: s.UntagInstanceProfileRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"InstanceProfileName", (params["InstanceProfileName"] ?? '').toString());
  ...
  async untagOpenIDConnectProvider(
    params: s.UntagOpenIDConnectProviderRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"OpenIDConnectProviderArn", (params["OpenIDConnectProviderArn"] ?? '').toString());
  ...
  async untagServerCertificate(
    params: s.UntagServerCertificateRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"ServerCertificateName", (params["ServerCertificateName"] ?? '').toString());
  ...
  async updateAccessKey(
    params: s.UpdateAccessKeyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    if ("UserName" in params) body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async updateLoginProfile(
    params: s.UpdateLoginProfileRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async updateOpenIDConnectProviderThumbprint(
    params: s.UpdateOpenIDConnectProviderThumbprintRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"OpenIDConnectProviderArn", (params["OpenIDConnectProviderArn"] ?? '').toString());
  ...
  async updateRoleDescription(
    params: s.UpdateRoleDescriptionRequest,
  ...
  async updateSAMLProvider(
    params: s.UpdateSAMLProviderRequest,
  ...
  async updateSSHPublicKey(
    params: s.UpdateSSHPublicKeyRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async updateServerCertificate(
    params: s.UpdateServerCertificateRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"ServerCertificateName", (params["ServerCertificateName"] ?? '').toString());
  ...
  async updateServiceSpecificCredential(
    params: s.UpdateServiceSpecificCredentialRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    if ("UserName" in params) body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async updateSigningCertificate(
    params: s.UpdateSigningCertificateRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    if ("UserName" in params) body.append(prefix+"UserName", (params["UserName"] ?? '').toString());
  ...
  async uploadSSHPublicKey(
    params: s.UploadSSHPublicKeyRequest,
  ...
  async uploadServerCertificate(
    params: s.UploadServerCertificateRequest,
  ...
  async uploadSigningCertificate(
    params: s.UploadSigningCertificateRequest,
