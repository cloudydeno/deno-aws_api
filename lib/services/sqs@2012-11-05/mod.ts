...
export default class SQS {
  ...
  async changeMessageVisibility(
    {abortSignal, ...params}: RequestConfig & ChangeMessageVisibilityRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async changeMessageVisibilityBatch(
    {abortSignal, ...params}: RequestConfig & ChangeMessageVisibilityBatchRequest,
  ...
  async deleteMessage(
    {abortSignal, ...params}: RequestConfig & DeleteMessageRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async deleteMessageBatch(
    {abortSignal, ...params}: RequestConfig & DeleteMessageBatchRequest,
  ...
  async getQueueAttributes(
    {abortSignal, ...params}: RequestConfig & GetQueueAttributesRequest,
  ...
  async getQueueUrl(
    {abortSignal, ...params}: RequestConfig & GetQueueUrlRequest,
  ...
  async listDeadLetterSourceQueues(
    {abortSignal, ...params}: RequestConfig & ListDeadLetterSourceQueuesRequest,
  ): Promise<ListDeadLetterSourceQueuesResult> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async listQueueTags(
    {abortSignal, ...params}: RequestConfig & ListQueueTagsRequest,
  ): Promise<ListQueueTagsResult> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
    const resp = await this.#client.performRequest({
  ...
  async purgeQueue(
    {abortSignal, ...params}: RequestConfig & PurgeQueueRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async receiveMessage(
    {abortSignal, ...params}: RequestConfig & ReceiveMessageRequest,
  ...
  async sendMessageBatch(
    {abortSignal, ...params}: RequestConfig & SendMessageBatchRequest,
  ...
  async setQueueAttributes(
    {abortSignal, ...params}: RequestConfig & SetQueueAttributesRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async tagQueue(
    {abortSignal, ...params}: RequestConfig & TagQueueRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
  ...
  async untagQueue(
    {abortSignal, ...params}: RequestConfig & UntagQueueRequest,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"QueueUrl", (params["QueueUrl"] ?? '').toString());
...
function ChangeMessageVisibilityBatchRequestEntry_Serialize(body: URLSearchParams, prefix: string, params: ChangeMessageVisibilityBatchRequestEntry) {
...
function DeleteMessageBatchRequestEntry_Serialize(body: URLSearchParams, prefix: string, params: DeleteMessageBatchRequestEntry) {
    body.append(prefix+".Id", (params["Id"] ?? '').toString());
    body.append(prefix+".ReceiptHandle", (params["ReceiptHandle"] ?? '').toString());
}
...
function SendMessageBatchRequestEntry_Serialize(body: URLSearchParams, prefix: string, params: SendMessageBatchRequestEntry) {
    body.append(prefix+".Id", (params["Id"] ?? '').toString());
    body.append(prefix+".MessageBody", (params["MessageBody"] ?? '').toString());
    if ("DelaySeconds" in params) body.append(prefix+".DelaySeconds", (params["DelaySeconds"] ?? '').toString());
    if (params["MessageAttributes"]) qsP.appendMap(body, prefix+".MessageAttribute", params["MessageAttributes"], {"appender":MessageAttributeValue_Serialize,"keyName":".Name","valName":".Value","entryPrefix":"."})
