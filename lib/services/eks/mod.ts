...
export class EKS {
  ...
  async associateEncryptionConfig(
    params: s.AssociateEncryptionConfigRequest,
  ...
  async associateIdentityProviderConfig(
    params: s.AssociateIdentityProviderConfigRequest,
  ...
  async createFargateProfile(
    params: s.CreateFargateProfileRequest,
  ...
  async createNodegroup(
    params: s.CreateNodegroupRequest,
  ...
  async deleteNodegroup(
    params: s.DeleteNodegroupRequest,
  ...
  async describeAddonVersions(
    params: s.DescribeAddonVersionsRequest = {},
  ...
  async describeCluster(
    params: s.DescribeClusterRequest,
  ...
  async describeFargateProfile(
    params: s.DescribeFargateProfileRequest,
  ...
  async describeIdentityProviderConfig(
    params: s.DescribeIdentityProviderConfigRequest,
  ...
  async describeNodegroup(
    params: s.DescribeNodegroupRequest,
  ...
  async listFargateProfiles(
    params: s.ListFargateProfilesRequest,
  ...
  async listIdentityProviderConfigs(
    params: s.ListIdentityProviderConfigsRequest,
  ...
  async listNodegroups(
    params: s.ListNodegroupsRequest,
  ...
  async updateClusterConfig(
    params: s.UpdateClusterConfigRequest,
  ...
  async updateNodegroupVersion(
    params: s.UpdateNodegroupVersionRequest,
