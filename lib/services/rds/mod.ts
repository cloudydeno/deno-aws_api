...
export class RDS {
  ...
  async addRoleToDBCluster(
    params: s.AddRoleToDBClusterMessage,
  ): Promise<void> {
  ...
  async addRoleToDBInstance(
    params: s.AddRoleToDBInstanceMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async addSourceIdentifierToSubscription(
    params: s.AddSourceIdentifierToSubscriptionMessage,
  ...
  async addTagsToResource(
    params: s.AddTagsToResourceMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
  ...
  async authorizeDBSecurityGroupIngress(
    params: s.AuthorizeDBSecurityGroupIngressMessage,
  ...
  async backtrackDBCluster(
    params: s.BacktrackDBClusterMessage,
  ...
  async cancelExportTask(
    params: s.CancelExportTaskMessage,
  ...
  async copyDBClusterParameterGroup(
    params: s.CopyDBClusterParameterGroupMessage,
  ...
  async copyDBSnapshot(
    params: s.CopyDBSnapshotMessage,
  ...
  async copyOptionGroup(
    params: s.CopyOptionGroupMessage,
  ...
  async createCustomAvailabilityZone(
    params: s.CreateCustomAvailabilityZoneMessage,
  ...
  async createDBCluster(
    params: s.CreateDBClusterMessage,
  ...
  async createDBClusterEndpoint(
    params: s.CreateDBClusterEndpointMessage,
  ...
  async createDBClusterParameterGroup(
    params: s.CreateDBClusterParameterGroupMessage,
  ...
  async createDBClusterSnapshot(
    params: s.CreateDBClusterSnapshotMessage,
  ...
  async createDBInstance(
    params: s.CreateDBInstanceMessage,
  ...
  async createDBInstanceReadReplica(
    params: s.CreateDBInstanceReadReplicaMessage,
  ...
  async createDBParameterGroup(
    params: s.CreateDBParameterGroupMessage,
  ...
  async createDBProxyEndpoint(
    params: s.CreateDBProxyEndpointRequest,
  ...
  async createDBSecurityGroup(
    params: s.CreateDBSecurityGroupMessage,
  ...
  async createDBSnapshot(
    params: s.CreateDBSnapshotMessage,
  ...
  async createDBSubnetGroup(
    params: s.CreateDBSubnetGroupMessage,
  ...
  async createEventSubscription(
    params: s.CreateEventSubscriptionMessage,
  ...
  async createGlobalCluster(
    params: s.CreateGlobalClusterMessage = {},
  ...
  async createOptionGroup(
    params: s.CreateOptionGroupMessage,
  ...
  async deleteCustomAvailabilityZone(
    params: s.DeleteCustomAvailabilityZoneMessage,
  ...
  async deleteDBCluster(
    params: s.DeleteDBClusterMessage,
  ...
  async deleteDBClusterEndpoint(
    params: s.DeleteDBClusterEndpointMessage,
  ): Promise<s.DBClusterEndpoint> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBClusterEndpointIdentifier", (params["DBClusterEndpointIdentifier"] ?? '').toString());
  ...
  async deleteDBClusterParameterGroup(
    params: s.DeleteDBClusterParameterGroupMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBClusterParameterGroupName", (params["DBClusterParameterGroupName"] ?? '').toString());
  ...
  async deleteDBClusterSnapshot(
    params: s.DeleteDBClusterSnapshotMessage,
  ...
  async deleteDBInstance(
    params: s.DeleteDBInstanceMessage,
  ...
  async deleteDBInstanceAutomatedBackup(
    params: s.DeleteDBInstanceAutomatedBackupMessage = {},
  ...
  async deleteDBParameterGroup(
    params: s.DeleteDBParameterGroupMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBParameterGroupName", (params["DBParameterGroupName"] ?? '').toString());
  ...
  async deleteDBSecurityGroup(
    params: s.DeleteDBSecurityGroupMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBSecurityGroupName", (params["DBSecurityGroupName"] ?? '').toString());
  ...
  async deleteDBSnapshot(
    params: s.DeleteDBSnapshotMessage,
  ...
  async deleteGlobalCluster(
    params: s.DeleteGlobalClusterMessage,
  ...
  async describeAccountAttributes(): Promise<s.AccountAttributesMessage> {
    const body = new URLSearchParams;
    const resp = await this.#client.performRequest({
      body,
  ...
  async describeCertificates(
    params: s.DescribeCertificatesMessage = {},
  ...
  async describeCustomAvailabilityZones(
    params: s.DescribeCustomAvailabilityZonesMessage = {},
  ...
  async describeDBClusterBacktracks(
    params: s.DescribeDBClusterBacktracksMessage,
  ...
  async describeDBClusterParameterGroups(
    params: s.DescribeDBClusterParameterGroupsMessage = {},
  ...
  async describeDBClusterParameters(
    params: s.DescribeDBClusterParametersMessage,
  ...
  async describeDBClusterSnapshotAttributes(
    params: s.DescribeDBClusterSnapshotAttributesMessage,
  ...
  async describeDBClusterSnapshots(
    params: s.DescribeDBClusterSnapshotsMessage = {},
  ...
  async describeDBClusters(
    params: s.DescribeDBClustersMessage = {},
  ...
  async describeDBEngineVersions(
    params: s.DescribeDBEngineVersionsMessage = {},
  ...
  async describeDBInstances(
    params: s.DescribeDBInstancesMessage = {},
  ...
  async describeDBLogFiles(
    params: s.DescribeDBLogFilesMessage,
  ...
  async describeDBParameterGroups(
    params: s.DescribeDBParameterGroupsMessage = {},
  ...
  async describeDBParameters(
    params: s.DescribeDBParametersMessage,
  ...
  async describeDBProxies(
    params: s.DescribeDBProxiesRequest = {},
  ...
  async describeDBProxyEndpoints(
    params: s.DescribeDBProxyEndpointsRequest = {},
  ...
  async describeDBProxyTargetGroups(
    params: s.DescribeDBProxyTargetGroupsRequest,
  ...
  async describeDBSecurityGroups(
    params: s.DescribeDBSecurityGroupsMessage = {},
  ...
  async describeDBSnapshotAttributes(
    params: s.DescribeDBSnapshotAttributesMessage,
  ...
  async describeDBSnapshots(
    params: s.DescribeDBSnapshotsMessage = {},
  ...
  async describeEngineDefaultParameters(
    params: s.DescribeEngineDefaultParametersMessage,
  ...
  async describeEventSubscriptions(
    params: s.DescribeEventSubscriptionsMessage = {},
  ...
  async describeEvents(
    params: s.DescribeEventsMessage = {},
  ...
  async describeExportTasks(
    params: s.DescribeExportTasksMessage = {},
  ...
  async describeGlobalClusters(
    params: s.DescribeGlobalClustersMessage = {},
  ...
  async describeInstallationMedia(
    params: s.DescribeInstallationMediaMessage = {},
  ...
  async describeOptionGroupOptions(
    params: s.DescribeOptionGroupOptionsMessage,
  ...
  async describeOptionGroups(
    params: s.DescribeOptionGroupsMessage = {},
  ...
  async describeOrderableDBInstanceOptions(
    params: s.DescribeOrderableDBInstanceOptionsMessage,
  ...
  async describeReservedDBInstances(
    params: s.DescribeReservedDBInstancesMessage = {},
  ...
  async describeSourceRegions(
    params: s.DescribeSourceRegionsMessage = {},
  ...
  async describeValidDBInstanceModifications(
    params: s.DescribeValidDBInstanceModificationsMessage,
  ...
  async failoverDBCluster(
    params: s.FailoverDBClusterMessage,
  ...
  async failoverGlobalCluster(
    params: s.FailoverGlobalClusterMessage,
  ...
  async importInstallationMedia(
    params: s.ImportInstallationMediaMessage,
  ): Promise<s.InstallationMedia> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"CustomAvailabilityZoneId", (params["CustomAvailabilityZoneId"] ?? '').toString());
  ...
  async listTagsForResource(
    params: s.ListTagsForResourceMessage,
  ...
  async modifyCurrentDBClusterCapacity(
    params: s.ModifyCurrentDBClusterCapacityMessage,
  ...
  async modifyDBCluster(
    params: s.ModifyDBClusterMessage,
  ...
  async modifyDBClusterEndpoint(
    params: s.ModifyDBClusterEndpointMessage,
  ): Promise<s.DBClusterEndpoint> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBClusterEndpointIdentifier", (params["DBClusterEndpointIdentifier"] ?? '').toString());
  ...
  async modifyDBInstance(
    params: s.ModifyDBInstanceMessage,
  ...
  async modifyDBParameterGroup(
    params: s.ModifyDBParameterGroupMessage,
  ...
  async modifyDBProxyTargetGroup(
    params: s.ModifyDBProxyTargetGroupRequest,
  ...
  async modifyDBSnapshot(
    params: s.ModifyDBSnapshotMessage,
  ...
  async modifyDBSnapshotAttribute(
    params: s.ModifyDBSnapshotAttributeMessage,
  ...
  async modifyDBSubnetGroup(
    params: s.ModifyDBSubnetGroupMessage,
  ...
  async modifyEventSubscription(
    params: s.ModifyEventSubscriptionMessage,
  ...
  async modifyOptionGroup(
    params: s.ModifyOptionGroupMessage,
  ...
  async rebootDBInstance(
    params: s.RebootDBInstanceMessage,
  ...
  async registerDBProxyTargets(
    params: s.RegisterDBProxyTargetsRequest,
  ...
  async removeRoleFromDBCluster(
    params: s.RemoveRoleFromDBClusterMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBClusterIdentifier", (params["DBClusterIdentifier"] ?? '').toString());
  ...
  async removeRoleFromDBInstance(
    params: s.RemoveRoleFromDBInstanceMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBInstanceIdentifier", (params["DBInstanceIdentifier"] ?? '').toString());
  ...
  async removeSourceIdentifierFromSubscription(
    params: s.RemoveSourceIdentifierFromSubscriptionMessage,
  ...
  async removeTagsFromResource(
    params: s.RemoveTagsFromResourceMessage,
  ): Promise<void> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"ResourceName", (params["ResourceName"] ?? '').toString());
  ...
  async resetDBClusterParameterGroup(
    params: s.ResetDBClusterParameterGroupMessage,
  ): Promise<s.DBClusterParameterGroupNameMessage> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBClusterParameterGroupName", (params["DBClusterParameterGroupName"] ?? '').toString());
  ...
  async resetDBParameterGroup(
    params: s.ResetDBParameterGroupMessage,
  ): Promise<s.DBParameterGroupNameMessage> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"DBParameterGroupName", (params["DBParameterGroupName"] ?? '').toString());
  ...
  async restoreDBClusterFromS3(
    params: s.RestoreDBClusterFromS3Message,
  ...
  async restoreDBClusterFromSnapshot(
    params: s.RestoreDBClusterFromSnapshotMessage,
  ...
  async restoreDBClusterToPointInTime(
    params: s.RestoreDBClusterToPointInTimeMessage,
  ...
  async restoreDBInstanceFromDBSnapshot(
    params: s.RestoreDBInstanceFromDBSnapshotMessage,
  ...
  async restoreDBInstanceFromS3(
    params: s.RestoreDBInstanceFromS3Message,
  ...
  async startActivityStream(
    params: s.StartActivityStreamRequest,
  ...
  async startDBCluster(
    params: s.StartDBClusterMessage,
  ...
  async startDBInstance(
    params: s.StartDBInstanceMessage,
  ...
  async startDBInstanceAutomatedBackupsReplication(
    params: s.StartDBInstanceAutomatedBackupsReplicationMessage,
  ...
  async startExportTask(
    params: s.StartExportTaskMessage,
  ): Promise<s.ExportTask> {
    const body = new URLSearchParams;
    const prefix = '';
    body.append(prefix+"ExportTaskIdentifier", (params["ExportTaskIdentifier"] ?? '').toString());
  ...
  async stopActivityStream(
    params: s.StopActivityStreamRequest,
  ...
  async stopDBInstance(
    params: s.StopDBInstanceMessage,
