...
| ACMPCA | `acm-pca@2017-08-22` | 38 KiB | 1.1 sec |
...
| ApplicationAutoScaling | `application-autoscaling@2016-02-06` | 26 KiB | 1.1 sec |
...
| CostExplorer | `ce@2017-10-25` | 86 KiB | 3.1 sec |
...
| CognitoIdentity | `cognito-identity@2014-06-30` | 27 KiB | 1.5 sec |
...
| ComputeOptimizer | `compute-optimizer@2019-11-01` | 36 KiB | 1.4 sec |
| ConfigService | `config@2014-11-12` | 139 KiB | 2.6 sec |
...
| CustomerProfiles | `customer-profiles@2020-08-15` | 42 KiB | 1.6 sec |
...
| DevOpsGuru | `devops-guru@2020-12-01` | 43 KiB | 1.7 sec |
...
| LexModelsV2 | `models.lex.v2@2020-08-07` | 100 KiB | 3.7 sec |
| CloudWatch | `monitoring@2010-08-01` | 60 KiB | 3.5 sec |
...
| QLDBSession | `qldb-session@2019-07-11` | 9 KiB | 2.0 sec |
...
| ResourceGroups | `resource-groups@2017-11-27` | 22 KiB | 1.7 sec |
...
| LexRuntimeV2 | `runtime.lex.v2@2020-08-07` | 17 KiB | 2.0 sec |
...
| ServiceQuotas | `service-quotas@2019-06-24` | 23 KiB | 1.8 sec |
| ServiceCatalog | `servicecatalog@2015-12-10` | 128 KiB | 3.3 sec |
| ServiceCatalogAppRegistry | `servicecatalog-appregistry@2020-06-24` | 22 KiB | 2.2 sec |
