...
| `cloudwatch@2010-08-01` | 60 KiB | 3.7 sec |
...
| `iam@2010-05-08` | 188 KiB | 4.4 sec |
...
| `kinesis@2013-12-02` | 32 KiB | 1.8 sec |
...
| `lambda@2015-03-31` | 100 KiB | 3.2 sec |
...
| `rds@2013-01-10` | 94 KiB | 2.9 sec |
| `rds@2013-02-12` | 101 KiB | 3.0 sec |
| `rds@2013-09-09` | 109 KiB | 3.5 sec |
| `rds@2014-09-01` | 112 KiB | 3.2 sec |
| `rds@2014-10-31` | 321 KiB | 6.1 sec |
...
| `ses@2010-12-01` | 94 KiB | 2.9 sec |
| `sesv2@2019-09-27` | 111 KiB | 3.3 sec |
...
| `sqs@2012-11-05` | 29 KiB | 3.5 sec |
| `ssm@2014-11-06` | 264 KiB | 7.2 sec |
