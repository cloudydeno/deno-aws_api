...
| --- | ---: | ---: |
| `accessanalyzer@2019-11-01` | 48 KiB | 2.4 sec |
| `acm@2015-12-08` | 23 KiB | 2.0 sec |
| `acmpca@2017-08-22` | 38 KiB | 1.8 sec |
| `alexaforbusiness@2017-11-09` | 117 KiB | 3.2 sec |
| `amp@2020-08-01` | 7 KiB | 2.4 sec |
...
| `appflow@2020-08-23` | 96 KiB | 2.9 sec |
| `appintegrations@2020-07-29` | 11 KiB | 2.4 sec |
| `applicationautoscaling@2016-02-06` | 26 KiB | 1.7 sec |
| `applicationinsights@2018-11-25` | 34 KiB | 2.5 sec |
| `appmesh@2018-10-01` | 30 KiB | 2.7 sec |
| `appmesh@2019-01-25` | 122 KiB | 3.3 sec |
| `appstream@2016-12-01` | 69 KiB | 2.6 sec |
| `appsync@2017-07-25` | 60 KiB | 2.3 sec |
| `athena@2017-05-18` | 46 KiB | 2.8 sec |
| `auditmanager@2017-07-25` | 80 KiB | 3.2 sec |
| `augmentedairuntime@2019-11-07` | 8 KiB | 1.2 sec |
| `autoscaling@2011-01-01` | 104 KiB | 3.6 sec |
| `autoscalingplans@2018-01-06` | 22 KiB | 2.1 sec |
| `backup@2018-11-15` | 70 KiB | 2.5 sec |
| `batch@2016-08-10` | 53 KiB | 2.3 sec |
| `braket@2019-09-01` | 13 KiB | 1.7 sec |
| `budgets@2016-10-20` | 38 KiB | 3.1 sec |
| `chime@2018-05-01` | 218 KiB | 4.1 sec |
| `cloud9@2017-09-23` | 15 KiB | 2.1 sec |
| `clouddirectory@2016-05-10` | 121 KiB | 3.4 sec |
| `clouddirectory@2017-01-11` | 124 KiB | 2.9 sec |
| `cloudformation@2010-05-15` | 132 KiB | 8.4 sec |
...
| `cloudwatch@2010-08-01` | 60 KiB | 2.4 sec |
| `cloudwatchevents@2015-10-07` | 83 KiB | 2.5 sec |
| `cloudwatchlogs@2014-03-28` | 43 KiB | 2.4 sec |
| `codeartifact@2018-09-22` | 55 KiB | 2.9 sec |
| `codebuild@2016-10-06` | 90 KiB | 6.2 sec |
| `codecommit@2015-04-13` | 109 KiB | 3.6 sec |
| `codedeploy@2014-10-06` | 86 KiB | 4.9 sec |
| `codeguruprofiler@2019-07-18` | 36 KiB | 2.6 sec |
| `codegurureviewer@2019-09-19` | 26 KiB | 2.6 sec |
| `codepipeline@2015-07-09` | 75 KiB | 2.8 sec |
| `codestar@2017-04-19` | 22 KiB | 2.5 sec |
| `codestarconnections@2019-12-01` | 13 KiB | 2.2 sec |
| `codestarnotifications@2019-10-15` | 16 KiB | 1.6 sec |
| `cognitoidentity@2014-06-30` | 28 KiB | 5.6 sec |
| `cognitoidentityserviceprovider@2016-04-18` | 150 KiB | 3.2 sec |
| `cognitosync@2014-06-30` | 22 KiB | 1.8 sec |
| `comprehend@2017-11-27` | 99 KiB | 3.0 sec |
| `comprehendmedical@2018-10-30` | 33 KiB | 1.8 sec |
| `computeoptimizer@2019-11-01` | 36 KiB | 6.8 sec |
| `configservice@2014-11-12` | 140 KiB | 3.0 sec |
| `connect@2017-08-08` | 127 KiB | 3.4 sec |
| `connectcontactlens@2020-08-21` | 5 KiB | 1.1 sec |
| `connectparticipant@2018-09-07` | 13 KiB | 1.6 sec |
| `costexplorer@2017-10-25` | 88 KiB | 4.0 sec |
| `cur@2017-01-06` | 7 KiB | 2.4 sec |
| `customerprofiles@2020-08-15` | 53 KiB | 3.0 sec |
| `databrew@2017-07-25` | 60 KiB | 3.0 sec |
| `dataexchange@2017-07-25` | 39 KiB | 2.5 sec |
| `datapipeline@2012-10-29` | 23 KiB | 2.2 sec |
| `datasync@2018-11-09` | 48 KiB | 2.5 sec |
| `dax@2017-04-19` | 28 KiB | 1.7 sec |
| `detective@2018-10-26` | 11 KiB | 1.7 sec |
| `devicefarm@2015-06-23` | 101 KiB | 3.4 sec |
| `devopsguru@2020-12-01` | 44 KiB | 2.1 sec |
| `directconnect@2012-10-25` | 71 KiB | 2.3 sec |
| `directoryservice@2015-04-16` | 75 KiB | 2.8 sec |
| `discovery@2015-11-01` | 34 KiB | 2.3 sec |
| `dlm@2018-01-12` | 23 KiB | 2.3 sec |
| `dms@2016-01-01` | 126 KiB | 4.1 sec |
...
| `ebs@2019-11-02` | 11 KiB | 1.5 sec |
| `ec2@2016-11-15` | 1112 KiB | 13.0 sec |
| `ec2instanceconnect@2018-04-02` | 2 KiB | 1.2 sec |
| `ecr@2015-09-21` | 50 KiB | 3.2 sec |
| `ecrpublic@2020-10-30` | 30 KiB | 2.0 sec |
| `ecs@2014-11-13` | 130 KiB | 3.6 sec |
| `efs@2015-02-01` | 32 KiB | 1.8 sec |
| `eks@2017-11-01` | 62 KiB | 2.4 sec |
...
| `emr@2009-03-31` | 111 KiB | 3.0 sec |
| `emrcontainers@2020-10-01` | 28 KiB | 1.7 sec |
| `es@2015-01-01` | 90 KiB | 2.8 sec |
| `eventbridge@2015-10-07` | 83 KiB | 2.6 sec |
| `firehose@2015-08-04` | 66 KiB | 2.8 sec |
| `fis@2020-12-01` | 28 KiB | 2.5 sec |
| `fms@2018-01-01` | 41 KiB | 2.1 sec |
| `forecastqueryservice@2018-06-26` | 3 KiB | 1.7 sec |
| `forecastservice@2018-06-26` | 54 KiB | 2.8 sec |
| `frauddetector@2019-11-15` | 66 KiB | 2.6 sec |
| `fsx@2018-03-01` | 42 KiB | 2.2 sec |
| `gamelift@2015-10-01` | 137 KiB | 3.5 sec |
| `glacier@2012-06-01` | 48 KiB | 1.8 sec |
| `globalaccelerator@2018-08-08` | 56 KiB | 3.1 sec |
| `glue@2017-03-31` | 252 KiB | 5.6 sec |
| `greengrass@2017-06-07` | 132 KiB | 3.7 sec |
| `greengrassv2@2020-11-30` | 45 KiB | 2.3 sec |
...
| `mediaconvert@2017-08-29` | 252 KiB | 7.0 sec |
| `medialive@2017-10-14` | 312 KiB | 6.0 sec |
| `mediapackage@2017-10-12` | 46 KiB | 2.2 sec |
| `mediapackagevod@2018-11-07` | 34 KiB | 1.9 sec |
| `mediastore@2017-09-01` | 19 KiB | 1.4 sec |
| `mediastoredata@2017-09-01` | 7 KiB | 1.7 sec |
| `mediatailor@2018-04-23` | 56 KiB | 2.3 sec |
...
| `mq@2017-11-27` | 41 KiB | 2.0 sec |
| `mturk@2017-01-17` | 52 KiB | 2.3 sec |
| `mwaa@2020-07-01` | 22 KiB | 2.1 sec |
| `neptune@2014-10-31` | 139 KiB | 3.3 sec |
| `networkfirewall@2020-11-12` | 54 KiB | 2.4 sec |
...
| `pinpoint@2016-12-01` | 243 KiB | 5.4 sec |
| `pinpointemail@2018-07-26` | 62 KiB | 2.2 sec |
...
| `savingsplans@2019-06-28` | 22 KiB | 1.5 sec |
| `schemas@2019-12-02` | 37 KiB | 2.7 sec |
| `secretsmanager@2017-10-17` | 28 KiB | 1.9 sec |
| `securityhub@2018-10-26` | 308 KiB | 4.8 sec |
| `serverlessapplicationrepository@2017-09-08` | 25 KiB | 1.5 sec |
| `servicecatalog@2015-12-10` | 128 KiB | 3.2 sec |
| `servicecatalogappregistry@2020-06-24` | 23 KiB | 1.8 sec |
| `servicediscovery@2017-03-14` | 34 KiB | 2.1 sec |
| `servicequotas@2019-06-24` | 23 KiB | 2.2 sec |
| `ses@2010-12-01` | 99 KiB | 3.3 sec |
| `sesv2@2019-09-27` | 118 KiB | 3.1 sec |
| `shield@2016-06-02` | 38 KiB | 1.9 sec |
| `signer@2017-08-25` | 34 KiB | 2.0 sec |
| `simpledb@2009-04-15` | 13 KiB | 1.6 sec |
| `sms@2016-10-24` | 57 KiB | 2.5 sec |
| `snowball@2016-06-30` | 36 KiB | 1.8 sec |
| `sns@2010-03-31` | 33 KiB | 1.9 sec |
| `sqs@2012-11-05` | 29 KiB | 2.0 sec |
| `ssm@2014-11-06` | 267 KiB | 5.1 sec |
...
| `synthetics@2017-10-11` | 21 KiB | 1.6 sec |
| `textract@2018-06-27` | 15 KiB | 1.4 sec |
| `timestreamquery@2018-11-01` | 7 KiB | 1.7 sec |
...
| `waf@2015-08-24` | 91 KiB | 2.8 sec |
| `wafregional@2016-11-28` | 94 KiB | 2.6 sec |
| `wafv2@2019-07-29` | 73 KiB | 3.1 sec |
| `wellarchitected@2020-03-31` | 48 KiB | 2.4 sec |
| `workdocs@2016-05-01` | 65 KiB | 2.2 sec |
| `worklink@2018-09-25` | 34 KiB | 1.6 sec |
| `workmail@2017-10-01` | 52 KiB | 2.3 sec |
| `workmailmessageflow@2019-05-01` | 3 KiB | 1.5 sec |
| `workspaces@2015-04-08` | 70 KiB | 2.5 sec |
