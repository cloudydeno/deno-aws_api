...
| `cloudwatch@2010-08-01` | 59 KiB | 5.9 sec |
...
| `ec2@2016-11-15` | 1112 KiB | 10.0 sec |
...
| `elb@2012-06-01` | 46 KiB | 3.1 sec |
| `elbv2@2015-12-01` | 77 KiB | 5.9 sec |
...
| `iam@2010-05-08` | 186 KiB | 4.1 sec |
...
| `rds@2013-01-10` | 94 KiB | 2.7 sec |
| `rds@2013-02-12` | 101 KiB | 2.7 sec |
| `rds@2013-09-09` | 109 KiB | 3.1 sec |
| `rds@2014-09-01` | 112 KiB | 2.9 sec |
| `rds@2014-10-31` | 321 KiB | 5.1 sec |
...
| `sns@2010-03-31` | 32 KiB | 2.0 sec |
| `sqs@2012-11-05` | 29 KiB | 1.9 sec |
