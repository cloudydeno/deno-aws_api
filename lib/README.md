...
| Budgets | `budgets@2016-10-20.ts` | json | 21 KiB | 0.8 sec |
| CostExplorer | `ce@2017-10-25.ts` | json | 77 KiB | 1.4 sec |
...
| ComputeOptimizer | `compute-optimizer@2019-11-01.ts` | json | 23 KiB | 0.8 sec |
...
| EC2 | `ec2@2016-11-15.ts` | ec2 | 1024 KiB | 4.2 sec |
| EC2InstanceConnect | `ec2-instance-connect@2018-04-02.ts` | json | 2 KiB | 0.7 sec |
| ElastiCache | `elasticache@2015-02-02.ts` | query | 132 KiB | 1.4 sec |
| ElasticBeanstalk | `elasticbeanstalk@2010-12-01.ts` | query | 99 KiB | 1.8 sec |
...
| EventBridge | `eventbridge@2015-10-07.ts` | json | 37 KiB | 0.9 sec |
| CloudWatchEvents | `events@2015-10-07.ts` | json | 37 KiB | 1.4 sec |
...
| Kendra | `kendra@2019-02-03.ts` | json | 67 KiB | 1.1 sec |
...
| Neptune | `neptune@2014-10-31.ts` | query | 129 KiB | 1.8 sec |
...
| RDS | `rds@2014-10-31.ts` | query | 301 KiB | 2.2 sec |
...
| SageMaker | `sagemaker@2017-07-24.ts` | json | 328 KiB | 2.1 sec |
...
| Snowball | `snowball@2016-06-30.ts` | json | 30 KiB | 0.9 sec |
| SNS | `sns@2010-03-31.ts` | query | 31 KiB | 0.9 sec |
| SQS | `sqs@2012-11-05.ts` | query | 28 KiB | 0.9 sec |
| SSM | `ssm@2014-11-06.ts` | json | 223 KiB | 1.9 sec |
...
| Transfer | `transfer@2018-11-05.ts` | json | 22 KiB | 0.8 sec |
...
| WorkMail | `workmail@2017-10-01.ts` | json | 44 KiB | 1.0 sec |
