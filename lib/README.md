...
| --- | --- | ---: | ---: |
| AccessAnalyzer | `accessanalyzer@2019-11-01` | 25 KiB | 1.1 sec |
| ACM | `acm@2015-12-08` | 21 KiB | 0.8 sec |
| ACMPCA | `acmpca@2017-08-22` | 38 KiB | 1.6 sec |
...
| ApiGatewayV2 | `apigatewayv2@2018-11-29` | 120 KiB | 2.7 sec |
| AppConfig | `appconfig@2019-10-09` | 42 KiB | 0.9 sec |
| Appflow | `appflow@2020-08-23` | 90 KiB | 2.0 sec |
| AppIntegrations | `appintegrations@2020-07-29` | 11 KiB | 0.8 sec |
| ApplicationAutoScaling | `applicationautoscaling@2016-02-06` | 26 KiB | 1.3 sec |
| ApplicationInsights | `applicationinsights@2018-11-25` | 34 KiB | 1.2 sec |
| AppMesh | `appmesh@2018-10-01` | 30 KiB | 0.9 sec |
| AppMesh | `appmesh@2019-01-25` | 121 KiB | 2.1 sec |
| AppStream | `appstream@2016-12-01` | 69 KiB | 1.6 sec |
| AppSync | `appsync@2017-07-25` | 59 KiB | 1.1 sec |
| Athena | `athena@2017-05-18` | 40 KiB | 1.3 sec |
| AuditManager | `auditmanager@2017-07-25` | 80 KiB | 1.9 sec |
| AugmentedAIRuntime | `augmentedairuntime@2019-11-07` | 8 KiB | 1.1 sec |
| AutoScaling | `autoscaling@2011-01-01` | 103 KiB | 1.2 sec |
| AutoScalingPlans | `autoscalingplans@2018-01-06` | 22 KiB | 1.3 sec |
...
| Chime | `chime@2018-05-01` | 217 KiB | 4.6 sec |
...
| CloudFront | `cloudfront@2018-06-18` | 118 KiB | 1.4 sec |
| CloudFront | `cloudfront@2018-11-05` | 122 KiB | 1.4 sec |
| CloudFront | `cloudfront@2019-03-26` | 124 KiB | 1.4 sec |
| CloudFront | `cloudfront@2020-05-31` | 181 KiB | 1.7 sec |
...
| CloudSearch | `cloudsearch@2013-01-01` | 58 KiB | 2.1 sec |
| CloudSearchDomain | `cloudsearchdomain@2013-01-01` | 9 KiB | 0.7 sec |
| CloudTrail | `cloudtrail@2013-11-01` | 28 KiB | 0.8 sec |
| CloudWatch | `cloudwatch@2010-08-01` | 60 KiB | 2.0 sec |
| CloudWatchEvents | `cloudwatchevents@2015-10-07` | 54 KiB | 1.8 sec |
| CloudWatchLogs | `cloudwatchlogs@2014-03-28` | 43 KiB | 1.6 sec |
...
| CodeGuruReviewer | `codegurureviewer@2019-09-19` | 26 KiB | 1.5 sec |
| CodePipeline | `codepipeline@2015-07-09` | 65 KiB | 2.1 sec |
| CodeStar | `codestar@2017-04-19` | 22 KiB | 0.8 sec |
| CodeStarconnections | `codestarconnections@2019-12-01` | 13 KiB | 1.0 sec |
| CodeStarNotifications | `codestarnotifications@2019-10-15` | 16 KiB | 1.1 sec |
| CognitoIdentity | `cognitoidentity@2014-06-30` | 27 KiB | 1.4 sec |
| CognitoIdentityServiceProvider | `cognitoidentityserviceprovider@2016-04-18` | 148 KiB | 2.4 sec |
| CognitoSync | `cognitosync@2014-06-30` | 22 KiB | 1.1 sec |
| Comprehend | `comprehend@2017-11-27` | 98 KiB | 1.2 sec |
| ComprehendMedical | `comprehendmedical@2018-10-30` | 33 KiB | 0.9 sec |
| ComputeOptimizer | `computeoptimizer@2019-11-01` | 36 KiB | 1.6 sec |
| ConfigService | `configservice@2014-11-12` | 139 KiB | 2.7 sec |
| Connect | `connect@2017-08-08` | 126 KiB | 2.3 sec |
| ConnectContactLens | `connectcontactlens@2020-08-21` | 5 KiB | 1.0 sec |
| ConnectParticipant | `connectparticipant@2018-09-07` | 13 KiB | 1.1 sec |
| CostExplorer | `costexplorer@2017-10-25` | 86 KiB | 2.3 sec |
| CUR | `cur@2017-01-06` | 7 KiB | 0.7 sec |
| CustomerProfiles | `customerprofiles@2020-08-15` | 42 KiB | 1.6 sec |
| DataBrew | `databrew@2017-07-25` | 58 KiB | 1.8 sec |
...
| DevOpsGuru | `devopsguru@2020-12-01` | 43 KiB | 1.6 sec |
| DirectConnect | `directconnect@2012-10-25` | 70 KiB | 1.1 sec |
| DirectoryService | `directoryservice@2015-04-16` | 74 KiB | 1.8 sec |
| Discovery | `discovery@2015-11-01` | 33 KiB | 0.9 sec |
| DLM | `dlm@2018-01-12` | 23 KiB | 1.4 sec |
| DMS | `dms@2016-01-01` | 125 KiB | 3.4 sec |
...
| DynamoDBStreams | `dynamodbstreams@2012-08-10` | 10 KiB | 1.2 sec |
| EBS | `ebs@2019-11-02` | 11 KiB | 0.7 sec |
| EC2 | `ec2@2016-11-15` | 1106 KiB | 12.2 sec |
| EC2InstanceConnect | `ec2instanceconnect@2018-04-02` | 2 KiB | 1.0 sec |
| ECR | `ecr@2015-09-21` | 49 KiB | 0.9 sec |
| ECRPUBLIC | `ecrpublic@2020-10-30` | 27 KiB | 1.7 sec |
| ECS | `ecs@2014-11-13` | 122 KiB | 2.9 sec |
| EFS | `efs@2015-02-01` | 31 KiB | 2.8 sec |
| EKS | `eks@2017-11-01` | 52 KiB | 1.0 sec |
| ElastiCache | `elasticache@2015-02-02` | 147 KiB | 3.7 sec |
| ElasticBeanstalk | `elasticbeanstalk@2010-12-01` | 100 KiB | 1.3 sec |
| ElasticInference | `elasticinference@2017-07-25` | 9 KiB | 2.5 sec |
| ElasticTranscoder | `elastictranscoder@2012-09-25` | 42 KiB | 1.0 sec |
| ELB | `elb@2012-06-01` | 48 KiB | 2.3 sec |
| ELBv2 | `elbv2@2015-12-01` | 78 KiB | 2.2 sec |
| EMR | `emr@2009-03-31` | 108 KiB | 2.7 sec |
| EMRcontainers | `emrcontainers@2020-10-01` | 27 KiB | 1.4 sec |
| ES | `es@2015-01-01` | 81 KiB | 2.2 sec |
...
| ForecastQueryService | `forecastqueryservice@2018-06-26` | 3 KiB | 1.1 sec |
| ForecastService | `forecastservice@2018-06-26` | 53 KiB | 1.7 sec |
| FraudDetector | `frauddetector@2019-11-15` | 66 KiB | 3.3 sec |
...
| Glue | `glue@2017-03-31` | 250 KiB | 5.4 sec |
...
| HealthLake | `healthlake@2017-07-01` | 14 KiB | 2.1 sec |
...
| IoT1ClickDevicesService | `iot1clickdevicesservice@2018-05-14` | 13 KiB | 1.2 sec |
| IoT1ClickProjects | `iot1clickprojects@2018-05-14` | 17 KiB | 1.2 sec |
| IoTAnalytics | `iotanalytics@2017-11-27` | 73 KiB | 1.1 sec |
| IotData | `iotdata@2015-05-28` | 5 KiB | 1.1 sec |
| IotDeviceAdvisor | `iotdeviceadvisor@2020-09-18` | 22 KiB | 0.8 sec |
| IoTEvents | `iotevents@2018-07-27` | 40 KiB | 1.0 sec |
| IoTEventsData | `ioteventsdata@2018-10-23` | 10 KiB | 1.1 sec |
| IoTFleetHub | `iotfleethub@2020-11-03` | 9 KiB | 0.7 sec |
| IoTJobsDataPlane | `iotjobsdataplane@2017-09-29` | 8 KiB | 1.3 sec |
| IoTSecureTunneling | `iotsecuretunneling@2018-10-05` | 10 KiB | 0.6 sec |
| IoTSiteWise | `iotsitewise@2019-12-02` | 102 KiB | 4.8 sec |
| IoTThingsGraph | `iotthingsgraph@2018-09-06` | 42 KiB | 0.9 sec |
| IoTWireless | `iotwireless@2020-11-22` | 70 KiB | 3.1 sec |
| IVS | `ivs@2020-07-14` | 22 KiB | 0.8 sec |
| Kafka | `kafka@2018-11-14` | 53 KiB | 2.8 sec |
...
| KinesisVideoArchivedMedia | `kinesisvideoarchivedmedia@2017-09-30` | 12 KiB | 1.2 sec |
| KinesisVideoMedia | `kinesisvideomedia@2017-09-30` | 3 KiB | 1.1 sec |
| KinesisVideoSignalingChannels | `kinesisvideosignalingchannels@2019-12-04` | 3 KiB | 1.1 sec |
| KMS | `kms@2014-11-01` | 47 KiB | 1.9 sec |
| LakeFormation | `lakeformation@2017-03-31` | 24 KiB | 0.8 sec |
| Lambda | `lambda@2014-11-11` | 14 KiB | 0.8 sec |
| Lambda | `lambda@2015-03-31` | 99 KiB | 3.1 sec |
| LexModelBuildingService | `lexmodelbuildingservice@2017-04-19` | 69 KiB | 1.9 sec |
| LexModelsV2 | `lexmodelsv2@2020-08-07` | 100 KiB | 2.4 sec |
| LexRuntime | `lexruntime@2016-11-28` | 18 KiB | 1.2 sec |
| LexRuntimeV2 | `lexruntimev2@2020-08-07` | 17 KiB | 1.3 sec |
| LicenseManager | `licensemanager@2018-08-01` | 65 KiB | 1.8 sec |
| Lightsail | `lightsail@2016-11-28` | 200 KiB | 4.7 sec |
| Location | `location@2020-11-19` | 45 KiB | 0.9 sec |
| LookoutVision | `lookoutvision@2020-11-20` | 28 KiB | 1.5 sec |
| MachineLearning | `machinelearning@2014-12-12` | 47 KiB | 1.0 sec |
| Macie | `macie@2017-12-19` | 10 KiB | 0.7 sec |
| Macie2 | `macie2@2020-01-01` | 103 KiB | 2.8 sec |
| ManagedBlockchain | `managedblockchain@2018-09-24` | 44 KiB | 1.9 sec |
| MarketplaceCatalog | `marketplacecatalog@2018-09-17` | 11 KiB | 1.2 sec |
| MarketplaceCommerceAnalytics | `marketplacecommerceanalytics@2015-07-01` | 5 KiB | 0.6 sec |
| MarketplaceEntitlementService | `marketplaceentitlementservice@2017-01-11` | 3 KiB | 1.1 sec |
| MarketplaceMetering | `marketplacemetering@2016-01-14` | 7 KiB | 1.1 sec |
| MediaConnect | `mediaconnect@2018-11-14` | 42 KiB | 0.9 sec |
| MediaConvert | `mediaconvert@2017-08-29` | 251 KiB | 4.0 sec |
| MediaLive | `medialive@2017-10-14` | 304 KiB | 6.1 sec |
| MediaPackage | `mediapackage@2017-10-12` | 46 KiB | 1.0 sec |
| MediaPackageVod | `mediapackagevod@2018-11-07` | 31 KiB | 1.4 sec |
| MediaStore | `mediastore@2017-09-01` | 18 KiB | 0.8 sec |
| MediaStoreData | `mediastoredata@2017-09-01` | 7 KiB | 1.2 sec |
| MediaTailor | `mediatailor@2018-04-23` | 17 KiB | 0.8 sec |
| MigrationHub | `migrationhub@2017-05-31` | 21 KiB | 1.5 sec |
| MigrationHubConfig | `migrationhubconfig@2019-06-30` | 5 KiB | 1.1 sec |
...
| MTurk | `mturk@2017-01-17` | 51 KiB | 1.7 sec |
| MWAA | `mwaa@2020-07-01` | 21 KiB | 0.8 sec |
| Neptune | `neptune@2014-10-31` | 138 KiB | 1.5 sec |
| NetworkFirewall | `networkfirewall@2020-11-12` | 54 KiB | 1.7 sec |
...
| Organizations | `organizations@2016-11-28` | 50 KiB | 3.3 sec |
| Outposts | `outposts@2019-12-03` | 10 KiB | 1.6 sec |
| Personalize | `personalize@2018-05-22` | 65 KiB | 1.1 sec |
| PersonalizeEvents | `personalizeevents@2018-03-22` | 4 KiB | 1.1 sec |
| PersonalizeRuntime | `personalizeruntime@2018-05-22` | 4 KiB | 1.0 sec |
| PI | `pi@2018-02-27` | 7 KiB | 0.7 sec |
| Pinpoint | `pinpoint@2016-12-01` | 240 KiB | 5.3 sec |
| PinpointEmail | `pinpointemail@2018-07-26` | 61 KiB | 1.7 sec |
| PinpointSMSVoice | `pinpointsmsvoice@2018-09-05` | 14 KiB | 1.2 sec |
| Polly | `polly@2016-06-10` | 15 KiB | 0.7 sec |
| Pricing | `pricing@2017-10-15` | 5 KiB | 0.7 sec |
| QLDB | `qldb@2019-01-02` | 24 KiB | 0.8 sec |
| QLDBSession | `qldbsession@2019-07-11` | 9 KiB | 1.1 sec |
| QuickSight | `quicksight@2018-04-01` | 200 KiB | 4.9 sec |
...
| RDS | `rds@2014-10-31` | 311 KiB | 5.4 sec |
| RDSDataService | `rdsdataservice@2018-08-01` | 14 KiB | 1.2 sec |
| Redshift | `redshift@2012-12-01` | 179 KiB | 3.8 sec |
| RedshiftData | `redshiftdata@2019-12-20` | 13 KiB | 1.2 sec |
| Rekognition | `rekognition@2016-06-27` | 90 KiB | 1.3 sec |
| ResourceGroups | `resourcegroups@2017-11-27` | 22 KiB | 1.4 sec |
| ResourceGroupsTaggingAPI | `resourcegroupstaggingapi@2017-01-26` | 11 KiB | 1.9 sec |
| RoboMaker | `robomaker@2018-06-29` | 105 KiB | 5.0 sec |
...
| S3 | `s3@2006-03-01` | 250 KiB | 4.6 sec |
| S3Control | `s3control@2018-08-20` | 92 KiB | 2.9 sec |
| S3Outposts | `s3outposts@2017-07-25` | 4 KiB | 0.7 sec |
| SageMaker | `sagemaker@2017-07-24` | 531 KiB | 10.3 sec |
| SagemakerEdge | `sagemakeredge@2020-09-23` | 4 KiB | 1.1 sec |
| SageMakerFeatureStoreRuntime | `sagemakerfeaturestoreruntime@2020-07-01` | 4 KiB | 1.1 sec |
| SageMakerRuntime | `sagemakerruntime@2017-05-13` | 3 KiB | 1.0 sec |
...
| SecurityHub | `securityhub@2018-10-26` | 293 KiB | 7.0 sec |
| ServerlessApplicationRepository | `serverlessapplicationrepository@2017-09-08` | 25 KiB | 1.3 sec |
| ServiceCatalog | `servicecatalog@2015-12-10` | 128 KiB | 3.3 sec |
| ServiceCatalogAppRegistry | `servicecatalogappregistry@2020-06-24` | 22 KiB | 1.5 sec |
| ServiceDiscovery | `servicediscovery@2017-03-14` | 33 KiB | 0.9 sec |
| ServiceQuotas | `servicequotas@2019-06-24` | 23 KiB | 1.4 sec |
| SES | `ses@2010-12-01` | 98 KiB | 2.7 sec |
| SESV2 | `sesv2@2019-09-27` | 117 KiB | 4.2 sec |
| Shield | `shield@2016-06-02` | 35 KiB | 0.8 sec |
| Signer | `signer@2017-08-25` | 33 KiB | 0.9 sec |
| SimpleDB | `simpledb@2009-04-15` | 13 KiB | 1.3 sec |
...
| SSM | `ssm@2014-11-06` | 264 KiB | 5.4 sec |
| SSO | `sso@2019-06-10` | 6 KiB | 0.7 sec |
| SSOAdmin | `ssoadmin@2020-07-20` | 39 KiB | 1.4 sec |
| SSOOIDC | `ssooidc@2019-06-10` | 4 KiB | 1.0 sec |
| StepFunctions | `stepfunctions@2016-11-23` | 46 KiB | 1.5 sec |
...
| TimestreamQuery | `timestreamquery@2018-11-01` | 6 KiB | 1.1 sec |
| TimestreamWrite | `timestreamwrite@2018-11-01` | 16 KiB | 1.3 sec |
| TranscribeService | `transcribeservice@2017-10-26` | 44 KiB | 1.5 sec |
| Transfer | `transfer@2018-11-05` | 25 KiB | 1.7 sec |
| Translate | `translate@2017-07-01` | 24 KiB | 0.8 sec |
| WAF | `waf@2015-08-24` | 91 KiB | 1.2 sec |
| WAFRegional | `wafregional@2016-11-28` | 94 KiB | 2.2 sec |
